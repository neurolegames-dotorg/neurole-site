...
export default function NeuroanatomyPlayPage() {
  ...
  return (
    <main className="wrap game-shell">
      ...
      <button className="chat-fab show" id="learn-fab" aria-label="Explain this region"
        onClick={() => setAiOpen(true)}
        style={{ position: 'fixed', bottom: 26, right: 26, height: 50, padding: '0 22px 0 18px', borderRadius: 30, background: 'var(--neuro-blue-deep)', color: '#fff', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, boxShadow: '0 8px 22px rgba(0,0,0,.18)', fontFamily: 'var(--mono)', fontSize: 12.5, letterSpacing: '.06em', textTransform: 'uppercase', zIndex: 60 }}>
